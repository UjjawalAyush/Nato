...
public class RecyclerAdapter15 extends RecyclerView.Adapter<RecyclerAdapter15.RecyclerItemViewHolder> {
    public ArrayList<RecyclerData15> myList;
    ...
    public RecyclerAdapter15(ArrayList<RecyclerData15> myList) {
        this.myList = myList;
    }
    ...
    public void notifyData(ArrayList<RecyclerData15> myList) {
    ...
    public class RecyclerItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerItemViewHolder(final View parent) {
            super(parent);
            value=parent.findViewById(R.id.category1);
        }
    }
    public void clear() {
