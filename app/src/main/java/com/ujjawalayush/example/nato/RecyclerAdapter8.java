...
public class RecyclerAdapter8 extends RecyclerView.Adapter<RecyclerAdapter8.RecyclerItemViewHolder> {
        ...
        public RecyclerItemViewHolder(final View parent) {
            ...
            mainLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    builder.setTitle("Do you wish to Tag?");
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if(r==0){
                                long g=db.insertContact(myList.get(i).getNew(),myList.get(i).getUsername());
