...
public class RecyclerAdapter12 extends RecyclerView.Adapter<RecyclerAdapter12.RecyclerItemViewHolder> {
    public ArrayList<RecyclerData12> myList;
    ...
    public RecyclerAdapter12(ArrayList<RecyclerData12> myList) {
        this.myList = myList;
    }
                ...
                public void onClick(View v) {
                    ...
                    while(true){
                        if(d.getString(1).equals(myList.get(i).getUid())&&d.getString(2).equals(myList.get(i).getTrip())&&d.getString(4).equals(myList.get(i).getMessage())){
                            db.deleteNotification(Long.parseLong(d.getString(0)));
                            db.close();
                            break;
                        }
                        d.moveToNext();
